...
var knifeImage , fruit1, fruit2 ,fruit3,fruit4, monsterImage, gameOverImage, knife_snd, death_snd;
...
function preload(){
  ...
  knife_snd = loadSound("knifeSwoosh.mp3")
  death_snd = loadSound("gameover.mp3")
